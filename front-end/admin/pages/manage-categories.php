    ...
    <?php foreach ($categories as $c): ?>
      <section data-id="<?= $c['id'] ?>" class="js-editable-datum editable-datum">
        <div class="editable-datum__name-and-btns">
          <h3 class="js-category-name category-name editable-datum__name"><span class="category-name__num">#<?= $c['id'] ?></span> Категория "<?= $c['name'] ?>"</h3>
          <div class="editable-datum__btns">
        ...
        <section class="js-editable-datum__subsection js-dn editable-datum__subsection">
          ...
          <p class="db mb-1em">
            Скрыть категорию?&nbsp;
            <label style="font-size: .8em;">Нет <input type="radio" name="hide-<?= $c['id'] ?>" value="no" checked></label>
            <label style="font-size: .8em;">Да <input type="radio" name="hide-<?= $c['id'] ?>" value="yes"></label>
          </p>
          <label class="db mb-1em">
          ...
          <div class="mb-1em">
            Поменять картинку:
            <div class="editable-datum__imgs-grid">
              <div>
