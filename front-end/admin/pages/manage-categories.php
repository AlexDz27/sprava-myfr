    ...
    <?php for ($i = 0; $i < count($categories); $i++): $c = $categories[$i]; ?>
      <section data-id="<?= $c['id'] ?>" class="js-editable-datum editable-datum">
        <div class="editable-datum__name-and-btns">
          <h3 class="js-category-name category-name <?= $c['hidden'] ? 'category-name--hidden' : '' ?> editable-datum__name"><span class="category-name__num">#<?= $i + 1 ?></span> Категория "<?= $c['name'] ?>" <?= $c['hidden'] ? '(скрыта)' : '' ?></h3>
