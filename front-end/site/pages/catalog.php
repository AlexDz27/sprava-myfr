...
<!-- k templates here -->
<?php foreach ($products as $cat => $ps): ?>
  <template id="tmpl-<?= $cat ?>">
    <div class="t-list">
      <div class="t-list__ts">
        <?php $count = count($ps); ?>
        <?php for ($i = 0; $i <= 15; $i++): $product = $ps[$i]; ?>
          <div class="t <?= $product['isHit'] ? 't--hit' : '' ?>">
            <p class="t__iz"><?= $i + 1 ?> из <?= $count ?></p>
            <div class="t__body">
              <div class="t__img-cont <?= ($cat === 'kisti' && $i === 1) ? 't__img-cont--kist-2' : '' ?>">
                <img width="150" height="150" src="<?= $product['img'] ?>" alt="<?= $product['name'] ?>">
              </div>
              <div class="t__text">
                <p><?= $product['name'] ?></p>
    ...
    <div class="t-list t-list--no-stretch">
      <div class="t-list__ts">
        <?php for ($i = 16; $i <= 31; $i++): $product = $ps[$i]; ?>
          <div class="t <?= $product['isHit'] ? 't--hit' : '' ?>">
            <p class="t__iz"><?= $i + 1 ?> из <?= $count ?></p>
            <div class="t__body">
              <div class="t__img-cont">
    ...
    <?php if ($count >= 32): ?>
      <div class="t-list t-list--no-stretch">
        <div class="t-list__ts">
          <?php for ($i = 32; $i < $count; $i++): $product = $ps[$i]; ?>
            <div class="t <?= $product['isHit'] ? 't--hit' : '' ?>">
              <p class="t__iz"><?= $i + 1 ?> из <?= $count ?></p>
              <div class="t__body">
                <div class="t__img-cont">
                  <img class="t__img" src="<?= $product['img'] ?>" alt="<?= $product['name'] ?>">
                </div>
                <div class="t__text">
                  <p><?= $product['name'] ?></p>
                  <p class="text--semibold"><?= $product['price'] ?> BYN<br>(с НДС 20%) / <?= $product['unit'] ?></p>
