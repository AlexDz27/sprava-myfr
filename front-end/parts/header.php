...
<header class="header cont">
  <div class="text-with-icon text-with-icon--pin">
    <img class="text-with-icon__icon" src="./front-end/assets/img/icons/pin.svg" width="14" height="18">
  ...
  <div class="header__row-2-col header__row-2-col--1">
    ...
    <div id="search" class="search header__search">
      ...
      <button class="btn-icon search__icon" type="button"><img src="./front-end/assets/img/icons/search.svg" width="15" height="14"></button>
      <div id="searchResults" class="search__results"></div>
    </div>
    <div class="text-with-icon header__text-with-icon--row-2-col-1">
      <img class="text-with-icon__icon" src="./front-end/assets/img/icons/envelope.svg" width="19" height="14">
  ...
  <div class="header__row-2-col">
    ...
    <button id="btnDownloadPrice" class="btn btn--dropdown" type="button">
      <b>СКАЧАТЬ ПРАЙС</b>
      <img class="btn--dropdown__icon" src="./front-end/assets/img/icons/arrow-down.svg" width="17" height="10">
    ...
    <button id="btnNav" class="btn-burger"><img src="./front-end/assets/img/icons/burger.svg" width="36" height="26"></button>
  </div>
</header>
<header class="header--mob cont--mob--fluid">
  <a class="header--mob__btn-phone header--mob__btn-phone--real" href="tel:+375445006080"><img src="./front-end/assets/img/icons/phone--larger.svg" width="32" height="28"></a>
  <button id="btnNavMob" class="header--mob__btn-phone"><img src="./front-end/assets/img/icons/burger.svg" width="36" height="26"></button>
</header>